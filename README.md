...
- 🎯 Entry points to execute your program using `python -m <vidmate>` or `$ vidmate` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/KingJem/VidMate/branch/main/graph/badge.svg?token=VidMate_token_here)](https://codecov.io/gh/KingJem/VidMate)
[![CI](https://github.com/KingJem/VidMate/actions/workflows/main.yml/badge.svg)](https://github.com/KingJem/VidMate/actions/workflows/main.yml)

Awesome vidmate created by KingJem

## Install

from source
```bash
git clone https://github.com/KingJem/VidMate vidmate
cd vidmate
make install
```
...
```bash
$ vidmate run --port 8080
```

or

```bash
python -m vidmate run --port 8080
```
...
```bash
❯ vidmate --help
Usage: vidmate [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ vidmate create-user --help
Usage: vidmate create-user [OPTIONS] USERNAME PASSWORD
...
```bash
vidmate create-user admin admin --superuser
```
...
Run with `vidmate run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `vidmate create-user`.
...
-----------------------------------------------------
vidmate/__init__.py              4      0   100%
vidmate/app.py                  16      1    94%
vidmate/cli.py                  21      0   100%
vidmate/config.py                5      0   100%
vidmate/db.py                   10      0   100%
vidmate/models/__init__.py       0      0   100%
vidmate/models/content.py       47      1    98%
vidmate/routes/__init__.py      11      0   100%
vidmate/routes/content.py       52     25    52%
vidmate/routes/security.py      15      1    93%
vidmate/routes/user.py          52     26    50%
vidmate/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in vidmate/default.toml.
